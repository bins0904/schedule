...
const scheduleData = [
    ...
    { w: 3, date: "2026/3/11", day: "三", time: "13:10-17:00", type: "臨診輪訓", title: "第一週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    ...
    { w: 4, date: "2026/3/17", day: "二", time: "13:10-17:00", type: "臨診輪訓", title: "第二週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    { w: 4, date: "2026/3/18", day: "三", time: "10:10-11:00", type: "心血管", title: "胎兒循環與先天性心臟病外科", teacher: "武孟餘", loc: "B0204", note: "" },
    { w: 4, date: "2026/3/18", day: "三", time: "13:10-17:00", type: "臨診輪訓", title: "第三週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    ...
    { w: 5, date: "2026/3/24", day: "二", time: "13:10-17:00", type: "臨診輪訓", title: "第四週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    { w: 5, date: "2026/3/25", day: "三", time: "10:10-11:00", type: "心血管", title: "瓣膜心臟病內科治療", teacher: "陳俊吉", loc: "B0204", note: "" },
    { w: 5, date: "2026/3/25", day: "三", time: "13:10-17:00", type: "臨診輪訓", title: "第五週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    ...
    { w: 6, date: "2026/3/31", day: "二", time: "13:10-17:00", type: "臨診輪訓", title: "第六週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },

    // Week 7
    { w: 6, date: "2026/4/1", day: "三", time: "13:10-17:00", type: "臨診輪訓", title: "第七週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    ...
    { w: 7, date: "2026/4/8", day: "三", time: "13:10-17:00", type: "臨診輪訓", title: "第八週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    ...
    { w: 8, date: "2026/4/14", day: "二", time: "13:10-17:00", type: "臨診輪訓", title: "第九週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    ...
    { w: 8, date: "2026/4/15", day: "三", time: "13:10-17:00", type: "臨診輪訓", title: "第十週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    ...
    // Week 9
    { w: 9, date: "2026/4/20", day: "一", time: "13:10-17:00", type: "臨診輪訓", title: "第11週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    { w: 9, date: "2026/4/21", day: "二", time: "13:10-17:00", type: "臨技實作", title: "分組跑台時段", teacher: "多位醫師", loc: "B2 技能中心", note: "G1-G12 (請見臨技附表確認當日項目)" },
    { w: 9, date: "2026/4/22", day: "三", time: "13:10-17:00", type: "臨診輪訓", title: "第12週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    ...
    { w: 10, date: "2026/4/28", day: "二", time: "13:10-17:00", type: "臨診輪訓", title: "第13週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    { w: 10, date: "2026/4/29", day: "三", time: "13:10-17:00", type: "臨診輪訓", title: "第14週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },

    // Week 11
    { w: 11, date: "2026/5/4", day: "一", time: "13:10-17:00", type: "臨診輪訓", title: "第15週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    { w: 11, date: "2026/5/5", day: "二", time: "13:10-17:00", type: "臨診輪訓", title: "第16週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    { w: 11, date: "2026/5/6", day: "三", time: "13:10-17:00", type: "臨診輪訓", title: "第17週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    ...
    { w: 12, date: "2026/5/11", day: "一", time: "13:10-17:00", type: "臨診輪訓", title: "第18週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    ...
    { w: 12, date: "2026/5/13", day: "三", time: "13:10-17:00", type: "臨診輪訓", title: "第19週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    ...
    { w: 13, date: "2026/5/18", day: "一", time: "13:10-17:00", type: "臨診輪訓", title: "第20週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    ...
    { w: 13, date: "2026/5/19", day: "二", time: "13:10-17:00", type: "臨診輪訓", title: "第21週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    { w: 13, date: "2026/5/20", day: "三", time: "10:10-11:00", type: "免疫", title: "關節炎復健治療", teacher: "陳柏旭", loc: "B0204", note: "" },
    { w: 13, date: "2026/5/20", day: "三", time: "13:10-17:00", type: "臨診輪訓", title: "第22週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    ...
    { w: 14, date: "2026/5/26", day: "二", time: "13:10-17:00", type: "臨診輪訓", title: "第23週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    { w: 14, date: "2026/5/27", day: "三", time: "13:10-17:00", type: "臨診輪訓", title: "第24週輪訓", teacher: "各科醫師", loc: "各專科", note: "G1-G8 依輪訓大表前往各科" },
    ...
    { w: 16, date: "2026/6/8", day: "一", time: "13:10-17:00", type: "臨診輪訓", title: "輪訓期末補充教學", teacher: "各科醫師", loc: "各專科", note: "" },
    { w: 16, date: "2026/6/9", day: "二", time: "08:10-17:00", type: "考試", title: "🔥 期末 OSCE 考試", teacher: "謝明儒", loc: "另發通知", note: "整天" },
    { w: 16, date: "2026/6/9", day: "二", time: "13:10-17:00", type: "臨診輪訓", title: "輪訓期末補充教學", teacher: "各科醫師", loc: "各專科", note: "" },
...
function getTypeClass(type) {
    ...
    if (type.includes("臨診輪訓")) return "pill pill--ward";
